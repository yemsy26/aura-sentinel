...
pub async fn run_agent_loop(
    ...
    while step_count <= max_steps {
        let agent_prompt = format!(
            ...
            - DESPUÉS de usar TOOL_PROGRAMMER con éxito, es OBLIGATORIO usar TOOL_TESTER para validar tus cambios. ADEMÁS, DEBES IGNORAR completamente cualquier error previo de TOOL_TERMINAL en el historial, ya que el código acaba de ser reparado.\n\
