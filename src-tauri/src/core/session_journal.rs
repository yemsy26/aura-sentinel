...
pub struct Fase {
    ...
    /// Acceptance criterion â€” what the Critic checks to consider this phase done
...
pub struct SessionJournal {
    ...
    // PESP v2 â€” Phased Execution System
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    ...
    // MISSION PERSISTENCE â€” FSM State Snapshots (Fase 1)
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
/// Saves the session journal atomically: write â†’ fsync â†’ rename.
/// Returns Err if any step fails â€” checkpoint loss is a FATAL event, not a silent no-op.
...
/// Called by the meta-command handler â€” no LLM needed.
pub fn build_status_report(journal: &SessionJournal) -> String {
    if journal.objetivo.is_empty() {
        return "ðŸ“‹ No hay ninguna tarea activa registrada en este workspace.\n\
                El sistema no tiene memoria de misiones anteriores aquÃ­.\n\
                Puedes darme una nueva instrucciÃ³n cuando quieras."
            .to_string();
    }
    ...
    format!(
        "{status_icon} **Estado de la MisiÃ³n**\n\
         â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€\n\
         ðŸŽ¯ **Objetivo:** {objetivo}\n\
         ðŸ“Š **Estado:** {status}\n\
         ðŸ”¢ **Ãšltimo paso completado:** {paso}\n\
         ðŸ• **Ãšltima actualizaciÃ³n:** {ts}\n\
         ðŸ› ï¸  **Herramientas usadas:** {herramientas}\n\
         ðŸ“ **Archivos tocados:** {archivos}\n\
         â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€\n\
         ðŸ’¡ *Para continuar desde donde lo dejÃ©, dime: \"continÃºa\" o \"retoma la tarea\".*",
